...
if(isset($_POST['submit'])){
  ...
  $query="INSERT INTO typing_metrics (wpm) VALUES ('$wpm')";
    ...
    <form method="post">
      ...
      <div class="stats center">
        ...
        <div class="stat-block if">
          ...
          <input type="text" id="wpm" name="wpm" value="Display here">
        </div>
      </div>
...
<!-- Bootstrap script -->
    ...
    <!-- My Javascript -->
    <!-- <script src="resources/js/typingTest.js"></script> -->
    <script>
...
function displayScore(){
  ...
  //store wpm
  var wpm1 = factor*wordsCorrect;
  var wmp2 = document.getElementById("wpm");
  wmp2.value = wpm1;
}
